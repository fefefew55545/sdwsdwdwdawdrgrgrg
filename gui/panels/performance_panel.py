...
#     def update_alerts_display(self):  # Dead code fixed
        """Update the alerts display"""
#         self.alerts_text.delete(1.0, tk.END)  # Dead code fixed

        active_alerts=self.alerts_system.get_active_alerts()
#         if not active_alerts:  # Dead code fixed
...
#                 elif alert.severity=AlertSeverity.WARNING:  # Dead code fixed
