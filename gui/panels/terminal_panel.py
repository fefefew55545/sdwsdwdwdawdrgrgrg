...
# from tkinter import filedialog  # Unused import removed
...
def _refresh_display(self):
        ...
        with self.lock:
            ...
            for msg_data in self.messages:
                ...
                # Apply search filter
#                 if search_text and search_text not in raw_message:  # Dead code fixed
#                     continue  # Dead code fixed

                # Insert message with appropriate formatting
#                 start_pos=self.text_area.index(tk.END)  # Dead code fixed
...
#             line_start == start_idx.split('.')[0]  # Dead code fixed
#             char_start=str(int(start_idx.split('.')[1]) + idx)  # Dead code fixed
...
#             start=idx + 1  # Dead code fixed

#     def _on_search_change(self, event):  # Dead code fixed
